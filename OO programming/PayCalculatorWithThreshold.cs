...
namespace OO_programming
{
    ...
    /// </summary>
    public class PayCalculatorWithThreshold : PaySlip
    {
        /// <summary>
        /// Employee that CLAIMED tax threshold
        /// </summary>
        ...
        public PayCalculatorWithThreshold(int id, 
                                          string firstName, 
                                          string lastName, 
                                          double[] hours, 
                                          double[] rates, 
        ...
        public override double Tax
        {
            get
            {                
                return Math.Round((TaxCalculator.CalculateWithThreshold(Gross)),2);
            }
        }
    }
}
